...
data class Order (
    ...
    val receiptProofUrl: String = "",
    val receiptProofUploadedAtMillis: Long = 0,
    val fulfillmentStartedAtMillis: Long = 0,
    val autoCompletionDeadlineAtMillis: Long = 0,
    val completionType: String = "",
    val completionLabel: String = "",
    val autoCompletedAtMillis: Long = 0,
